 ...
 * [atrium-roadmap#39](https://github.com/robstoll/atrium-roadmap/issues/93) for details and to give feedback.
 *
 * @return An [Expect] for the current subject of the assertion.
 * @throws AssertionError Might throw an [AssertionError] if the assertion made is not correct.
 */
@Deprecated(
    ...
    ReplaceWith("this.toBeTheSameAs(expected)")
...
@Deprecated(
    ...
    ReplaceWith("this.notToBeTheSameAs(expected)")
) // TODO remove with 1.0.0
